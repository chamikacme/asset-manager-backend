...
export class OrganizationController {
  ...
  @Post('remove-member')
  @Roles(Role.SUPERADMIN, Role.ADMIN)
  removeMember(@Body('userId') userId: number, @GetUserDetails() user: User) {
    return this.organizationService.removeMember(userId, user.organization);
  }

  @Post('update-role')
  @Roles(Role.ADMIN)
  updateRole(@Body() updateRole: UpdateRoleDto, @GetUserDetails() user: User) {
    return this.organizationService.updateRole(updateRole, user.organization);
  }
}
